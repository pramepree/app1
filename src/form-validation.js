        ...
        <div className="mt-3 mb-5 mx-auto p-3 rounded" style={{ width: '400px', background: '#cee' }}>
            <form onSubmit={handleSubmit(onSubmitForm)}>
                ...
                <div className="form-group mb-3">
                    ...
                    {errors.price && <div style={err}>กำหนดราคาสิ้นค่าเป็นตัวเลขที่่มากกว่า 0</div>}
                </div>
                <div className="form-group mb-3">
                ...
                <div className='form-group mb-3'>
                    ...
                    <input type="date" id="dateAdded" name="dateAdded" className="form-control form-control-sm" {...register('dateAdded')} />
                </div>
                <div className="form-group mb-3">
